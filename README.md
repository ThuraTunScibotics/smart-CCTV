...
<img src="/video-data/cctv-normal.png" height="50%" width="50%" alt="CCTV view with normal condition" title="Do not save the frames in the storage">

<img src="/video-data/cctv-normal.png" height="50%" width="50%" alt="CCTV view with the thives enter the shop" title="Save the frames when changes happen">
